...
const Reward: React.FC = () => {
  ...
  const event2 = new Date(2026, 4, 15);
  const event3 = new Date(2026, 5, 15);
  const event4 = new Date(2026, 6, 15);
     ...
     <div
        ...
        {/* 첫 번째 박스 */}
          ...
          <div className="
            ...
            p-2
          ">
            <p className="text-xs font-normal text-white text-center">{t("reward_page.fifteen")} {t("reward_page.this_month")}</p>
            <p className="text-xs font-normal text-white text-center">{t("reward_page.ranking_rewards")}</p>
            <img 
              className="w-4 h-4"
              src={Images.RedTriangle}
          ...
          <div className="
            ...
            p-2
          ">
            <p className="text-xs font-normal text-white text-center">{t("reward_page.sixteen")} {t("reward_page.this_month")}</p>
            <p className="text-xs font-normal text-white text-center">{t("reward_page.ranking_rewards")}</p>
            <img 
              className="w-4 h-4"
              src={Images.RedTriangle}
